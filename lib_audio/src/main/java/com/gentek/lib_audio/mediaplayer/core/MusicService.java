...
import com.gentek.lib_audio.mediaplayer.events.AudioReleaseEvent;
import com.gentek.lib_audio.mediaplayer.events.AudioStartEvent;
import com.gentek.lib_audio.mediaplayer.model.SongBean;
import com.gentek.lib_audio.mediaplayer.view.NotificationHelper;
...
import static com.gentek.lib_audio.mediaplayer.view.NotificationHelper.NOTIFICATION_ID;
...
public class MusicService extends Service implements NotificationHelper.NotificationHelperListener {
     ...
     * 外部直接service方法
     */
    public static void startMusicService(ArrayList<SongBean> audioBeans) {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        mSongBeans = (ArrayList<SongBean>) intent.getSerializableExtra(DATA_AUDIOS);
    ...
    private void playMusic() {
        AudioController.getInstance().setQueue(mSongBeans);
